defmodule Roman do
  ...
  def numerals(number) do
    cond do
      ...
      div(number, 100) >= 1 -> translate(number, 100, %{9 => "CM", 5 => "D", 4 => "CD", 1 => "C"})
      div(number,  10) >= 1 -> translate(number,  10, %{9 => "XC", 5 => "L", 4 => "XL", 1 => "X"})
      div(number,   1) >= 1 -> translate(number,   1, %{9 => "IX", 5 => "V", 4 => "IV", 1 => "I"})
      true -> ""
    end
  end
